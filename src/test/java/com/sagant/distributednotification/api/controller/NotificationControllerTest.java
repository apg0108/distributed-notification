...
@WebMvcTest(controllers = NotificationController.class, excludeFilters = @Filter(type = FilterType.ASSIGNABLE_TYPE, classes = ApiKeyAuthFilter.class))
...
class NotificationControllerTest {
   ...
   void createNotification_withValidRequest_returnsOkWithServiceResponse() throws Exception {
      final NotificationRequest request = new NotificationRequest("user@example.com", NotificationChannel.LOG, "subject", "hello",
            NotificationPriority.HIGH, Map.of("k", "v"));
      final NotificationResponse response = new NotificationResponse(UUID.randomUUID(), "user@example.com", NotificationChannel.LOG, "subject",
            "hello", NotificationPriority.HIGH, Map.of("k", "v"), NotificationStatus.PENDING);
   ...
   void createNotification_missingRecipient_returns400WithFieldError() throws Exception {
      final NotificationRequest request = new NotificationRequest(null, NotificationChannel.LOG, null, "hello", null, null);
   ...
   void createNotification_missingChannel_returns400WithFieldError() throws Exception {
      final NotificationRequest request = new NotificationRequest("user@example.com", null, null, "hello", null, null);
   ...
   void createNotification_missingBody_returns400WithFieldError() throws Exception {
      final NotificationRequest request = new NotificationRequest("user@example.com", NotificationChannel.LOG, null, null, null, null);
   ...
   void createNotification_subjectTooLong_returns400WithFieldError() throws Exception {
      ...
      final NotificationRequest request = new NotificationRequest("user@example.com", NotificationChannel.LOG, tooLongSubject, "hello", null, null);
   ...
   void createNotification_emailChannelWithInvalidRecipientFormat_returns400WithFieldError() throws Exception {
      final NotificationRequest request = new NotificationRequest("not-an-email", NotificationChannel.EMAIL, null, "hello", null, null);
   ...
   void createNotification_nonEmailChannelWithNonEmailRecipient_returnsOk() throws Exception {
      final NotificationRequest request = new NotificationRequest("not-an-email", NotificationChannel.LOG, null, "hello", null, null);
      final NotificationResponse response = new NotificationResponse(UUID.randomUUID(), "not-an-email", NotificationChannel.LOG, null, "hello",
   ...
   void createNotification_withoutOptionalFields_stillSucceeds() throws Exception {
      final NotificationRequest request = new NotificationRequest("user@example.com", NotificationChannel.EMAIL, null, "hello", null, null);
      final NotificationResponse response = new NotificationResponse(UUID.randomUUID(), "user@example.com", NotificationChannel.EMAIL, null, "hello",
            NotificationPriority.MEDIUM, null, NotificationStatus.PENDING);
      when(notificationService.createNotification(request)).thenReturn(response);
